    ...
    public class WaterSourceInfoActivity : Activity
    {
        ...
        ***************************************************************************/
        async void getWaterSourceInfo(int id)
        {
            ...
            nameTextView.TextSize = 40;
            nameTextView.SetTextColor(Android.Graphics.Color.White);
            nameTextView.Left = 40;
            nameTextView.Right = 40;

            TextView locationTextView = FindViewById<TextView>(Resource.Id.txtWaterSourceLocationDetails);
            locationTextView.Text = location;
            locationTextView.TextSize = 30;
            locationTextView.SetTextColor(Android.Graphics.Color.White);
            locationTextView.Left = 40
            locationTextView.Right = 40;

            TextView capacityTextView = FindViewById<TextView>(Resource.Id.txtWaterSourceCapacityDetails);
            capacityTextView.Text = capacity;
            capacityTextView.TextSize = 30;
            capacityTextView.SetTextColor(Android.Graphics.Color.White);
            capacityTextView.Left = 40;
            capacityTextView.Right = 40;
            ...
            availabilityTextView.TextSize = 30;
            availabilityTextView.SetTextColor(Android.Graphics.Color.White);
            availabilityTextView.Left = 40;
            availabilityTextView.Right = 40;

            TextView regionTextView = FindViewById<TextView>(Resource.Id.txtWaterSourceRegionDetails);
            regionTextView.Text = region;
            regionTextView.TextSize = 30;
            regionTextView.SetTextColor(Android.Graphics.Color.White);
            regionTextView.Left = 40;
            regionTextView.Right = 40;
        }
