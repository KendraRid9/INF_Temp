...
namespace App1
{
    /*=======================================================================
       ...
       the causes of Cholera. This information is pulled from the DB 

   ========================================================================*/
    [Activity(Label = "CausesActivity")]
    public class CausesActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.CausesLayout);
        ...
        ***************************************************************************/
        async Task populateInfo()
        {
            ...
            LinearLayout linearLayout = FindViewById<LinearLayout>(Resource.Id.causesLinearLayout);
        ...
        ***************************************************************************/
        public async Task callAPIEndpoint()
        {
            try
            {
                ...
                request.RequestUri = new Uri("http://choltechcloudservice.cloudapp.net/api/CholeraController/getAllSources");
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    if (content != null)
                    {
                        ...
                        {
                            Toast.MakeText(Application.Context, "Causes Fetched!", ToastLength.Short).Show();
                        ...
                        {
                            Toast.MakeText(Application.Context, "Error Fetching Causes!" + jToken["message"].ToString(), ToastLength.Short).Show();
                        }
                    }
                    else
                    {
                        Toast.MakeText(Application.Context, "Error Fetching Causes!", ToastLength.Short).Show();
                    }
                }
                else
                {
                    Toast.MakeText(Application.Context, "Error Fetching Causes! Code: " + response.StatusCode, ToastLength.Short).Show();
                }
