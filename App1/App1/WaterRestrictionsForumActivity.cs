...
namespace App1
{
    ...
    ========================================================================*/
    [Activity(Label = "Water Restrictions Forum")]
    public class WaterRestrictionsForumActivity : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.WaterRestrictionsForumLayout);
           ...
           *
           **************************************************************************/
            Button addPostButton = FindViewById<Button>(Resource.Id.btnWaterRestrictionAddPost);
